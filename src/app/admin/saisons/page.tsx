    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[300px_1fr]">
        <Card padding="none" className="overflow-hidden self-start">
          <p className="px-4 py-3 text-[11px] tracking-[0.2em] text-cream-600 font-semibold border-b hairline">SAISONS</p>
          {seasons.length === 0 ? (
                ...
                return (
                  <li key={s.id}>
                    <Link
                      ...
                      className={cn("block px-4 py-3 hover:bg-coal-700/40", selected?.id === s.id && "bg-gold-400/10")}
                    >
